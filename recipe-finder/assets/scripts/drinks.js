...
let savedDrinks = JSON.parse(
  localStorage.getItem("userDrinkFavorites") || "[]"
);
...
https: function getDrinkFromIngredient(drinkIngredient) {
...
function invalidIngredient(drinkIngredient) {
  ...
  if (drinkIngredient) {
    errorMessage.textContent =
      "Sorry, there were no cocktails found with that ingredient.";
  } else if (cocktailName) {
    errorMessage.textContent =
      "Sorry, there were no cocktails found with that name.";
  }
